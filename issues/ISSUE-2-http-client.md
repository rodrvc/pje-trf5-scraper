...
- Explicit **ISO-8859-1** decoding: request an `arraybuffer` and convert with
  iconv-lite before parsing, or the accents corrupt
...
- explicit ISO-8859-1 decoding with iconv-lite before handing off to cheerio

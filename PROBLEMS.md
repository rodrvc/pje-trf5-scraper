...
Initially the page was found to answer in ISO-8859-1 rather than UTF-8: decoded with
the default, accents corrupt ("APELAÇÃO" becomes "APELAÃÃO").

**But the site does not use a single encoding.** While capturing fixtures, inspecting
the raw bytes showed:
